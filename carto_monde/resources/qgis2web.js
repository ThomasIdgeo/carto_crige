...
map.getView().fit([-18594400.157456, -44927335.427097, 19637773.057133, 44927335.427097], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">La carte du monde</h2>';
        return titleElement;
    })(),
